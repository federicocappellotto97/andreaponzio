...
const DarkModeToggle = ({ className, currentColor = false }: { className?: string; currentColor?: boolean }) => {
  ...
  return (
    <>
      <button
        className={cx('dark:hidden inline-block group', className)}
      ...
      >
        <svg
          ...
          className={cx(
            'group-hover:fill-[var(--current-color)] transition-colors duration-300 ease-out',
      ...
      <button
        className={cx('hidden dark:inline-block group', className)}
      ...
      >
        <svg
          ...
          className={cx(
            'group-hover:fill-[var(--current-color)] transition-colors duration-300 ease-out',
            currentColor ? 'fill-current' : 'fill-white'
          )}
        >
