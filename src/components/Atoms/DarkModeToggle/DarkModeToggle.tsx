...
const DarkModeToggle = ({}) => {
  ...
  return (
    <>
      <button className="dark:hidden inline-block group" onClick={() => setMode('dark')} aria-label="Dark Mode">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          viewBox="0 -960 960 960"
          className="group-hover:fill-[var(--current-color)] transition-colors duration-300 ease-out"
        >
      ...
      <button className="hidden dark:inline-block group" onClick={() => setMode('light')} aria-label="Light Mode">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          width="24"
          height="24"
          viewBox="0 -960 960 960"
          className="fill-white group-hover:fill-[var(--current-color)] transition-colors duration-300 ease-out"
        >
